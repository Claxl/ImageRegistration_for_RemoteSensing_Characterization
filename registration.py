...
def process_image_pair(sar_img_path, opt_img_path, detector, matcher, ratio_thresh=0.7):
    ...
    Returns:
        tuple: Contains (num_keypoints_sar, num_keypoints_opt, num_matches, num_inliers, 
               matrix_rmse, execution_time, registered_img, matches_img)
    """
    ...
    return num_keypoints_sar, num_keypoints_opt, num_matches, num_inliers, transformation_matrix, execution_time, registered_img, matches_img

def process_image_pair_with_gt(sar_img, opt_img, detector, matcher, landmarks_mov, landmarks_fix, transform_gt=None, ratio_thresh=0.7):
    """
